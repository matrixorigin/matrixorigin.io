...
For more information, see [DRANT PRIVILEGES](../../Reference/SQL-Reference/Data-Control-Language/grant-privileges.md).
...
For more information, see [DRANT ROLE](../../Reference/SQL-Reference/Data-Control-Language/grant-role.md).
