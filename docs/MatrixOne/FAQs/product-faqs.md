...
MatrixOne is now available in version v25.3.0.4. We've done a lot of optimization work on stability, and it's ready to be used in the production business.
