...
description: "Comprehensive list of MySQL features and syntax that MatrixOne does not (fully) support."
---
...
> - **Partial Support** entries are extracted from `differs_from_mysql`
