...
|  ----  | ----  |  ----  | ----  |
| FLOAT32  | 4 bytes | 	23 bits  | FLOAT(M, D) <br> The value range of M is (1=< M <=255). <br> The value range of D is (1=< D <=30), and M >= D. |
| FLOAT64  | 8 bytes |  53 bits  | DOUBLE(M, D) <br> The value range of M is (1=< M <=255). <br> The value range of D is (1=< D <=30), and M >= D.|
