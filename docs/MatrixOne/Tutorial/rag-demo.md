...
"The lastest version of MatrixOne is v25.3.0.0,released on 2025/08/26."
...
```
Based on the provided data, the latest version of MatrixOne is v25.3.0.0, which was released on 2025/08/26. 
```
