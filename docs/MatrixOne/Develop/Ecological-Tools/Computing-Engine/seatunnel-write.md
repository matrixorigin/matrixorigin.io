...
2. Use the [mo_ctl](https://docs.matrixorigin.cn/1.0.1/MatrixOne/Maintain/mo_ctl/) tool to import the MySQL DDL statements into MatrixOne directly. Execute the following command:
