...
2. Use the [mo\_ctl](https://docs.matrixorigin.cn/1.2.3/MatrixOne/Maintain/mo_ctl/) tool to import MySQL's DDL statements directly into MatrixOne. Execute the following command:
