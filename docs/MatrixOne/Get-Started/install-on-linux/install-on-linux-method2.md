...
=== "**Downloading method 3: Go to the page and download**"
     ...
     If you want a more intuitive way to download the page, go to the [version 0.6.0](https://github.com/matrixorigin/matrixone/releases/tag/v0.6.0), pull down to find the **Assets** column, and click the installation package *mo-v0.6.0-linux-amd64.zip* can be downloaded.
