...
=== "Stable Version Image(1.2.4 version)"

      ```bash
      docker pull matrixorigin/matrixone:1.2.4
      ...
      ```bash
      docker pull registry.cn-shanghai.aliyuncs.com/matrixorigin/matrixone:1.2.4
      docker run -d -p 6001:6001 --name matrixone registry.cn-shanghai.aliyuncs.com/matrixorigin/matrixone:1.2.4
      ```
...
mo_ctl set_conf MO_CONTAINER_IMAGE="matrixorigin/matrixone:1.2.4" # Set image
