...
=== "Stable Version Image(3.0.2 version)"

      ```bash
      docker pull matrixorigin/matrixone:3.0.2
      ...
      ```bash
      docker pull registry.cn-shanghai.aliyuncs.com/matrixorigin/matrixone:3.0.2
      docker run -d -p 6001:6001 --name matrixone registry.cn-shanghai.aliyuncs.com/matrixorigin/matrixone:3.0.2
      ```
...
mo_ctl set_conf MO_CONTAINER_IMAGE="matrixorigin/matrixone:3.0.2" # Set image
