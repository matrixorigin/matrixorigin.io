...
=== "**Downloading method 1: Using `wget` to install binary packages**"
     ...
     wget https://github.com/matrixorigin/matrixone/releases/download/v3.0.0/mo-v3.0.0-darwin-x86_64.zip
     unzip -d matrixone/ mo-v3.0.0-darwin-x86_64.zip
     ```
     ...
     ```bash
     mkdir -p /User/username/mo/matrixone & cd /User/username/mo
     wget https://github.com/matrixorigin/matrixone/releases/download/v3.0.0/mo-v3.0.0-darwin-arm64.zip
     unzip -d matrixone/ mo-v3.0.0-darwin-arm64.zip
     ```
...
=== "**Downloading method 2: Using `curl` to install binary packages**"
     ...
     ```bash
     mkdir -p /User/username/mo/matrixone & cd /User/username/mo
     curl -OL https://github.com/matrixorigin/matrixone/releases/download/v3.0.0/mo-v3.0.0-darwin-x86_64.zip
     unzip -d matrixone/ mo-v3.0.0-darwin-x86_64.zip
     ```
     ...
     ```bash
     mkdir -p /User/username/mo/matrixone & cd /User/username/mo
     curl -OL https://github.com/matrixorigin/matrixone/releases/download/v3.0.0/mo-v3.0.0-darwin-arm64.zip
     unzip -d matrixone/ mo-v-darwin-arm64.zip
     ```

=== "**Downloading method 3: Go to the page and download**"

     If you want a more intuitive way to download the page, go to the [version 3.0.0](https://github.com/matrixorigin/matrixone/releases/tag/v3.0.0), pull down to find the **Assets** column, and click the installation package *mo-v3.0.0-darwin-x86_64.zip* or *mo-v3.0.0-darwin-arm64.zip* can be downloaded.
...
````
mo_ctl set_conf MO_PATH="/yourpath/mo-v3.0.0-xx-xx" # Set the MO_PATH to the directory where the binary files are extracted
mo_ctl set_conf MO_CONF_FILE="/yourpath/mo-v3.0.0-xx-xx/etc/launch/launch.toml" # Set the MO_CONF_FILE path
...
If the operation is regular, the following log will appear. The relevant operation logs of MatrixOne will be in `/yourpath/mo-v3.0.0-xx-xx/matrixone/logs/ .
...
2024-03-07 14:34:05.072 UTC+0800    [INFO]    Starting mo-service: cd /Users/admin/mo-v3.0.0-darwin-arm64/ && GOMEMLIMIT=14745MiB /Users/admin/mo-v3.0.0-darwin-arm64/mo-service -daemon -debug-http :9876 -launch /Users/admin/mo-v3.0.0-darwin-arm64/etc/launch/launch.toml >/Users/admin/mo-v3.0.0-darwin-arm64/matrixone/logs/stdout-20240307_143405.log 2>/Users/admin/mo-v3.0.0-darwin-arm64/matrixone/logs/stderr-20240307_143405.log
...
2024-03-07 14:34:07.261 UTC+0800    [INFO]    At least one mo-service is running. Process info: 
  501 27145     1   0  2:34下午 ??         0:00.18 /Users/admin/mo-v3.0.0-darwin-arm64/mo-service -daemon -debug-http :9876 -launch /Users/admin/mo-v3.0.0-darwin-arm64/etc/launch/launch.toml
