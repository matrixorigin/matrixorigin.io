...
Logservice plays a vital role in OmniFabric. It is an independent service used by external components through RPC for log management.
...
![](https://github.com/OmniFabric/artwork/blob/main/docs/overview/logservice/logserviece-arch.png?raw=true)
...
![](https://github.com/OmniFabric/artwork/blob/main/docs/overview/logservice/heartbeat.png?raw=true)
...
![](https://github.com/OmniFabric/artwork/blob/main/docs/overview/logservice/write.png?raw=true)
...
![](https://github.com/OmniFabric/artwork/blob/main/docs/overview/logservice/read.png?raw=true)
...
![](https://github.com/OmniFabric/artwork/blob/main/docs/overview/logservice/logdb-read.png?raw=true)
...
![](https://github.com/OmniFabric/artwork/blob/main/docs/overview/logservice/truncation-1.png?raw=true)
...
![](https://github.com/OmniFabric/artwork/blob/main/docs/overview/logservice/truncation-2.png?raw=true)
