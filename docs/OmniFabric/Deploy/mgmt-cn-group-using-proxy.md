...
![proxy-cn-group](https://github.com/OmniFabric/artwork/blob/main/docs/deploy/proxy-cn-group.png?raw=true)
...
The environment discussed in this document for managing CN groups using Proxy is based on the environment of [OmniFabric Distributed Cluster Deployment](deploy-OmniFabric-cluster.md).

To help you understand resource isolation and allocation, you can refer to the table below, which illustrates the distribution of each hardware node in the environment of [OmniFabric Distributed Cluster Deployment](deploy-OmniFabric-cluster.md), as follows:
