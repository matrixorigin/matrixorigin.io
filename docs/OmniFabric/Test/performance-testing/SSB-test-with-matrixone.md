# **Complete a SSB Test with OmniFabric**

The Star Schema Benchmark(SSB)Test is a popular scenario for OLAP database performance test. By going through this tutorial, you'll learn how to complete a SSB Test with OmniFabric.
...
### Option 1: Load the sigle table dataset into related tables with this command in OmniFabric
...
### Flat table queries expected results
...
### Multiple tables queries expected results
