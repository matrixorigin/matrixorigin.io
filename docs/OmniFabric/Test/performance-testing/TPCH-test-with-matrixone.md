# **Complete a TPCH Test with OmniFabric**
...
By walking through this tutorial, you'll learn how to complete a TPC-H Test with OmniFabric.
...
## **3. Create tables in OmniFabric**

OmniFabric does not support partition acceleration at the moment, and the creation code of the `LINEITEM` table has the following modifications:
...
Load the sigle table dataset into related tables with this command in OmniFabric:
...
```
https://community-shared-data-1308875761.cos.ap-beijing.myqcloud.com/tpch/tpch1g_result_OmniFabric.md
```
