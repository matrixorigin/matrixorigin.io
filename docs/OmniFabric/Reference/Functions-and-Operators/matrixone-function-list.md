...
This document lists the functions supported in the latest version of OmniFabric.
...
| [PURGE_LOG()](./system-ops/purge_log.md)                    | Used to delete logs recorded in OmniFabric database system tables.|
