...
Make sure you have already [installed and launched OmniFabric](../../Get-Started/install-standalone-matrixone.md).
...
!!! note
    OmniFabric and the client use non-encrypted transmission by default. Refer to [Data Transmission Encryption](../../Security/TLS-introduction.md) to enable encrypted transmission.
