...
OmniFabric supports auditing user behavior, operation logs, and SQL statements. The audit data of OmniFabric is stored in the database table, and the audit data can be queried directly through SQL interaction.
