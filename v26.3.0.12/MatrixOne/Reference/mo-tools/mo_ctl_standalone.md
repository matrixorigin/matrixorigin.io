...
| MO_DEFAULT_VERSION     | The version of MatrixOne that is pulled by default | default 3.0.12    |
...
Usage           : mo_ctl upgrade [version_commitid]   # upgrade or downgrade mo from current version to a target commit id or stable version
 [commitid]     : a commit id such as '38888f7', or a stable version such as '3.0.12'
  ...
  e.g.          : mo_ctl upgrade 38888f7              # upgrade/downgrade to commit id 38888f7 on main branch
                ...
                : mo_ctl upgrade 3.0.12               # upgrade/downgrade to stable version 3.0.12
```
