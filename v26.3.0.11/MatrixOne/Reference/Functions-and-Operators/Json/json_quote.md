...
llms_summary: "The JSON_QUOTE function is used to convert a string value to a string in JSON format."
---
# **JSON_QUOTE()**

> The JSON_QUOTE function is used to convert a string value to a string in JSON format.
