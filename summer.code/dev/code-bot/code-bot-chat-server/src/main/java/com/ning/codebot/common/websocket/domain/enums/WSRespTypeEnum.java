package com.ning.codebot.common.websocket.domain.enums;

import com.ning.codebot.common.websocket.domain.vo.resp.*;
...
public enum WSRespTypeEnum {
    LOGIN_URL(1, "登录页面返回", WSLoginUrl.class),
    LOGIN_SCAN_SUCCESS(2, "用户等待授权", null),
    ...
    APPLY(10, "仓库申请", WSFriendApply.class),
