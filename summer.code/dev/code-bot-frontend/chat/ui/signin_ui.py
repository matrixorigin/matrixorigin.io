...
"border-radius:12px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Opportunity Copilot"))
        self.label_2.setText(_translate("Form", "Insight data"))
        self.label_3.setText(_translate("Form", "Recommendation"))
        self.label_4.setText(_translate("Form", "Summary"))
        self.label_5.setText(_translate("Form", "Close deals smarter, win together."))
import res_rc
